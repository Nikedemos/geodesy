...
class LatLonEllipsoidal_Vincenty extends LatLonEllipsoidal {
    ...
    destinationPointNumber(distance, initialBearing) {
        return this.directNumber(Number(distance), Number(initialBearing)).point;
    }
    ...
    /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
    /**
     * Vincenty direct calculation (Number).
     *
     ...
     */
    directNumber(distance, initialBearing) {
